        ...
        return (
            ...
            React.createElement("div", {className: "row"}, 
              React.createElement("div", {className: "col-sm-6"}, 
                ...
                React.createElement("div", {id: "r-hello-template", style: {height: 600}}, 
                  React.createElement(Highlight, {lang: "R", domain: domain, code: DeploySamples.R, username: this.state.user.Name, apikey: this.state.user.Apikey, data: this.state.modelInput, highlightStyle: {fontSize: 14, height: 350}})
                )
              ), 
              React.createElement("div", {class: "col-sm-6"}, 
                React.createElement("h4", null, "Python"), 
                React.createElement("div", {id: "py-hello-template", style: {height: 600}}, 
                  React.createElement(Highlight, {lang: "python", domain: domain, code: DeploySamples.Python, username: this.state.user.Name, apikey: this.state.user.Apikey, data: this.state.modelInput, highlightStyle: {fontSize: 14, height: 350}})
                )
              )
            )
            )
    ...
    render: function() {
        return (
            React.createElement("div", null, 
                ...
                React.createElement("h4", null, "Models"), 
...
React.render(React.createElement(FilterableModelTable, {url: "/models", pollInterval: 1000}), document.getElementById('search-bar'));
// enable all tooltips at once
$('[data-toggle="tooltip"]').tooltip();

React.render(React.createElement(SharedModelTable, {pollInterval: 1000}), document.getElementById('shared-models'));
